  ...
  return (
    <>
      ...
      <div className="introThree">
        <h2>How to Apply for the Centre for Undergraduate Research</h2>
        <p>
        ...
        <p>
          Write a "Program Details" website section (with bullet points
          highlighting differentiators) for the website of{" "}
          <b>Centre for Undergraduate Research</b> which provides affordable
          research opportunities for Bangladeshi undergraduates, has nice
          faculty and academic team, has many research collaborations with other
          organizations, and is trying to make research popular in Bangladesh.
          It has several parts: Introductory class, Pre Research skill
          workshops, Research Work, After Research Work.{" "}
        </p>
        <p>
          {" "}
        ...
        <ul className="list-alpha list-inside">
          <li>Intro to research + Course Goal </li>
          <li>Original work and review work details</li>
        </ul>
        <p>
          {" "}
          <b>Pre Research skill workshops:</b>
        </p>

        <ul className="list-alpha list-inside">
          <li>Google docs, forms, sheets & their formatting</li>
          <li>Zotero</li>
          <li>Data analysis, Basic graph creation with sheets</li>
          <li>Citation style</li>
          <li>Paraphrasing & plagiarism </li>
          <li>
            Paper finding, Reading, Article search & download, ethics of
            research
          </li>
        </ul>
        ...
        <ul className="list-alpha list-inside">
          <li>Mentor will fix paper topic & task division</li>
          <li>Research guide will ensure participants meeting deadlines</li>
          <li>Weekly 2 research meetings with research mentor</li>
          <li>Weekly 3 1:1 checkups by research guide</li>
        </ul>

        <p>
          {" "}
          <b>After research part:</b>{" "}
        </p>
        <ul className="list-alpha list-inside">
          <li>Paper writing</li>
          <li>Abstract, introduction</li>
          <li>Methodology, Result, conclusion</li>
          <li>Reference, figures, title, keyword</li>
        </ul>
      </div>
    </>
  );
